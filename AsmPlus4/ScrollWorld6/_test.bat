call _collect.bat
xcopy ..\..\Musics\LevelSongs\source\welt6_luca1.asm .\ /Y
del song.asm
ren welt6_luca1.asm song.asm
...
dasm.exe ..\..\..\Framework\trackmo\framework\driver_packed.asm -v1 -I..\..\..\Framework\trackmo\framework\ -o..\..\ScrollWorld6\leveltest.prg
cd ..\..\ScrollWorld6
yape leveltest.prg
