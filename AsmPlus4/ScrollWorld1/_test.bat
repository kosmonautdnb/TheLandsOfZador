call _collect.bat
rem ---------------- level musics
xcopy ..\..\Musics\LevelSongs\source\welt1_luca1.asm .\ /Y
del song.asm
ren welt1_luca1.asm song.asm
...
dasm.exe ..\..\..\Framework\trackmo\framework\driver_packed.asm -v1 -I..\..\..\Framework\trackmo\framework\ -o..\..\ScrollWorld1\leveltest.prg
cd ..\..\ScrollWorld1
yape leveltest.prg
