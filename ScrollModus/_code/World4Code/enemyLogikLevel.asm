...
HandleSpecialEnemy SUBROUTINE
	...
	lda GameObjectYPosLo,x
	sec 
	sbc GameObjectYPosLo + PLAYERGAMEOBJECT
	beq .noydifference ; a little wrong for memsave reasons

	lda GameObjectYPosHi,x
	sbc GameObjectYPosHi + PLAYERGAMEOBJECT
	bmi .ydifferenceNegative
	lda GameObjectYPosLo,x
	sec
	sbc #$01
	sta GameObjectYPosLo,x
...
.noydifference
	...
	sec 
	sbc GameObjectXPosLo + PLAYERGAMEOBJECT
	beq .noxdifference ; a little wrong for memsave reasons

	lda GameObjectXPosHi,x
	sbc GameObjectXPosHi + PLAYERGAMEOBJECT
	bmi .xdifferenceNegative
	lda #$00
	sta GameObjectFlags1,x
	jmp .noxdifference
.xdifferenceNegative
