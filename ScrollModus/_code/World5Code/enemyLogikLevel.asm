...
InitBird SUBROUTINE
	...
	sta GameObjectSpriteValue,x
	sta GameObjectSpriteImage,x
	lda #ENEMY_ANIMTYPE_LOOP_FOURFRAME8|ENEMY_ANIMTYPE_SLOWER1|ENEMY_ANIMTYPE_YSINPLUS
	sta GameObjectAnimType,x
	lda #ENEMY_CONFIGURATIONFLAG_XMOVEMENT_HALVE_SPEED|ENEMY_CONFIGURATIONFLAG_PERIODICAL_SHOT
	sta GameObjectConfiguration,x
	jmp enemyFlippedX
...
InitThrower SUBROUTINE
	...
	lda #ENEMY_ANIMTYPE_LOOP_FRAME2|ENEMY_ANIMTYPE_SLOWER1
	sta GameObjectAnimType,x
	lda #ENEMY_CONFIGURATIONFLAG_XMOVEMENT_HALVE_SPEED|ENEMY_CONFIGURATIONFLAG_FLOOR_HANDLING
	sta GameObjectConfiguration,x
	jmp enemyFlippedX
...
InitSpecialEnemy SUBROUTINE
	lda #SPRITEFRAMES_SPECIAL
	sta GameObjectSpriteValue,x
	sta GameObjectSpriteImage,x
	lda #ENEMY_ANIMTYPE_LOOP_FRAME2|ENEMY_ANIMTYPE_SLOWER1
	sta GameObjectAnimType,x
	lda #ENEMY_CONFIGURATIONFLAG_XMOVEMENT
	sta GameObjectConfiguration,x
	rts
...
HandleSpecialEnemy SUBROUTINE
	lda #$00
	sta GameObjectSpritePaintWhite,x
	lda GameObjectVar9,x
	bne .onRand
	lda GameObjectFlags1,x
	cmp GameObjectVar8,x
	beq .notcollidered
	sta GameObjectVar8,x
	lda #$01
	sta GameObjectVar9,x
.notcollidered
	jmp HandleStandardEnemy
.onRand
	lda GameObjectVar9,x
	cmp #$01
	bne .notup
