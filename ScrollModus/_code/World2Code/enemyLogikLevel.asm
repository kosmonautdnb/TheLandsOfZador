...
HandleBackground SUBROUTINE
	...
	and #$3f
	beq .specialBackground		
.nospecialBackground
	rts
.specialBackground
	lda GameObjectSpriteValue,x
	cmp #SPRITEFRAMES_BACKGROUND
	bne .nospecialBackground

	lda #ENEMY_TYPE_SPECIALENEMY
	sta enemyAddEnemyType
	lda GameObjectXPosLo,x
	clc
	adc #$02
...
InitSpecialEnemy SUBROUTINE
	...
	lda #ENEMY_ANIMTYPE_LOOP_FRAME2|ENEMY_ANIMTYPE_SLOWER1
	sta GameObjectAnimType,x
	lda #ENEMY_CONFIGURATIONFLAG_GRAVITY|ENEMY_CONFIGURATIONFLAG_COLLISION_JUMPING
	sta GameObjectConfiguration,x
	lda #10
