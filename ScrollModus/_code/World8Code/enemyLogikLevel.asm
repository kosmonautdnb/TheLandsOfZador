...
portalEnabled dc.b $00
PORTALWAIT = $10

HandlePortalEnemy SUBROUTINE
	lda portalEnabled
	bne .jo
	rts
.jo

	lda GameObjectVar8,x
	cmp #PORTALWAIT
	beq .dontwait
	inc GameObjectVar8,x
	lda #$00
	sta GameObjectActiveCounter,x 
	rts
.dontwait

	jsr HandleStandardEnemy
	...
	lda GameObjectActiveCounter,x ; 32 * 8 = 256
	lsr
	lsr
	lsr
	and #31
